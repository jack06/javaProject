	...
	<body>
		<div class="admin-main">
		   ...
		   <div class="layui-input-inline">     
		     ...
		     发布人 ：
		   <div class="layui-input-inline">     
		        <select  name="faburen" id="faburen" class="layui-input">
		         <option value="">请选择</option>
			...
			layui.use(['icheck', 'laypage','layer','laydate'], function() {
					...
					jump: function(obj, first) {
						...
						if(!first) {
						 $.ajax({
				           ...
				           type:'post',
				           data:{"pageNo":obj.curr,"eventName":$('#eventName').val(),"eventStatus":$('#eventStatus').val(),"startTime":$('#LAY_demorange_s').val(),"endTime":$('#LAY_demorange_e').val(),"showStatus":$('#showStatus').val(),"faburen":$('#faburen').val()},
				...
				$('#search').on('click', function() {
						 $.ajax({
				            url:'/admin/event_getlist',
				           type:'post',
				           data:{"eventName":$('#eventName').val(),"eventStatus":$('#eventStatus').val(),"startTime":$('#LAY_demorange_s').val(),"endTime":$('#LAY_demorange_e').val(),"showStatus":$('#showStatus').val(),"faburen":$('#faburen').val()},
				           success:function(data) { 
                               str = ''; 
                            $.each(data,function(i,val){
                                str += '<tr>'      

...
public class AdminServiceImpl implements AdminService{
	...
	@Override
	public PageInfo<Tadmin> findByPage(PageInfo<Tadmin> page,Tadmin admin) throws Exception {
		// TODO Auto-generated method stub
		 PageHelper.offsetPage(page.getStartRow(), page.getPageSize());
		 page = new PageInfo<Tadmin>(adminMapper.findByPage(admin));
		 return page;

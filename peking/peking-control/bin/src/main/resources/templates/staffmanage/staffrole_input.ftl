			   ...
			   <#if userrole??><input type="hidden" name="id" value="${userrole.id}"></#if>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="roleName" <#if userrole??>value=${userrole.roleName}</#if>  lay-verify="required" autocomplete="off" placeholder="请输入角色名称" class="layui-input" style="width:190px;">
					</div>
				</div>			
				<div class="layui-form-item">
					<div class="layui-input-block">

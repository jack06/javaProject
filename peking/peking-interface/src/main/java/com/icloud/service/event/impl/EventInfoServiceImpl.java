...
public class EventInfoServiceImpl implements EventInfoService {
	...
	@Override
	public PageInfo<EventInfo> findFriendEvents(int pageNo,int pageSize,EventInfo ev) {
		PageHelper.startPage(pageNo, pageSize);
		List<EventInfo> list = eventInfoMapper.findFriendEvents(ev);
		PageInfo<EventInfo> page = new PageInfo<EventInfo>(list);
		return page;
	}

	@Override
	public PageInfo<EventInfo> findForAnnouncementList(int pageNo, int pageSize, EventInfo ev) {
		PageHelper.startPage(pageNo, pageSize);
		List<EventInfo> list = eventInfoMapper.findForAnnouncementList(ev);
		PageInfo<EventInfo> page = new PageInfo<EventInfo>(list);
		return page;
	}
